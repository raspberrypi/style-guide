...
*   MiniDisc – Sony trademark. Plural MiniDisc devices.  
...
*   outbox 
*   overclocking (noun), overclock (verb). Never the verb 'to clock', which may mean something else entirely. If in doubt, clarify. For example, 'dynamic frequency clocking'. 
...
*   PS2, PS3 – acceptable abbreviations for Sony's PlayStation 2 and PlayStation 3. 
*   Puppy Linux 
*   PyGame 
*   Python (language) 
