...
Formatting guidelines specific to the Raspberry Pi learning resources can be found in the [Style Guide for Raspberry Pi learning resources](../raspberrypilearning/style-guide-for-resources), which should be used in conjunction with this Style Guide.
