...
|Raspberry Pi Ltd|The commercial company that develops and manufactures **Raspberry Pi** computers, modules, other hardware, silicon, and software|Can usually drop "Ltd" unless necessary to distinguish from the **Raspberry Pi Foundation**|Raspberry Pi Trading, Raspberry Pi (Trading) Ltd|
...
|RISC-V|reduced instruction set computer 5|Only use the abbreviation; always include the hyphen; always write in all-caps|
