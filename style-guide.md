...
Formatting guidelines specific to the Raspberry Pi learning resources can be found in the [Style Guide for Raspberry Pi learning resources](../style-guide/style-guide-for-resources.md), which should be used in conjunction with this Style Guide.
